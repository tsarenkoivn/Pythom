...
Original file is located at
    https://colab.research.google.com/drive/1LsSpYjbH71G11tERtiaJgjzfDO25E8wK
...
side1 = float(input("Enter value of the first side: "))
side2 = float(input("Enter value of the second side: "))
side3 = float(input("Enter value of the third side: "))

if side1 + side2 > side3 or side1 + side3 > side2 or side3 + side2 > side1:
    triangle = "Triangle can be created"
else:
    triangle = "Triangle cant be created"
